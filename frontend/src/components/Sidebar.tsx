...
import { Upload, Cpu, BarChart3, ListChecks, ArrowLeft, History } from "lucide-react";
            ...
            <div className="bg-white dark:bg-slate-900/50 p-8 rounded-[3rem] shadow-2xl shadow-slate-200/40 dark:shadow-none border border-slate-100 dark:border-slate-800/50 backdrop-blur-xl">
                ...
                <form onSubmit={handleUpload} className="space-y-8">
                    ...
                    <button
                        ...
                        className="w-full py-4 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] hover:text-brand-500 hover:border-brand-500/30 transition-all flex items-center justify-center gap-3 shadow-sm"
                    >
                        <History className="w-4 h-4" /> View Neural Vault
                    </button>
                </form>
            </div>
        </div >
